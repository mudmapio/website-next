                      ...
                      <InboxIcon className="h-6 w-6 text-white"
                                ...
                                <div className="mt-6">
                                    <h2 className="text-3xl font-extrabold tracking-tight text-gray-900">
                                        Replace all those mouse clicks with an
                                        API-driven approach.
                                    </h2>
                                    <p className="mt-4 text-lg text-gray-500">
                                        If you’re tired of logging in and
                                        clicking through multiple panels and
                                        tabs then Mudmap has your back. Mudmap
                                        deploys an API to your firewall making
                                        remote manipulation easy. Now you can
                                        use one platform to view, update or
                                        delete records on your devices.
                                    </p>
                                    <div className="mt-6">
                                        <a
                                            href="#"
                                ...
                                <blockquote>
                                    <div>
                                        <p className="text-base text-gray-500">
                                            &ldquo;Cras velit quis eros eget
                                            rhoncus
                                            lacus ultrices sed diam. Sit orci
                                            risus
                                            aenean
                                            curabitur donec aliquet. Mi
                                            venenatis
                                            in
                                            euismod ut.&rdquo;
                                        </p>
                      ...
                      <SparklesIcon className="h-6 w-6 text-white"
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-4 text-lg text-gray-500">
                                        ...
                                        nunc
                                        sed.
                                        Ornare iaculis bibendum malesuada
                                        faucibus
                                        lacinia
                                        porttitor. Pulvinar laoreet sagittis
                                        viverra
                                        duis. In venenatis sem arcu pretium
                                        pharetra
                                        at.
                                        Lectus viverra dui tellus ornare
                                        pharetra.
                                    </p>
                                    <div className="mt-6">
                                        <a
