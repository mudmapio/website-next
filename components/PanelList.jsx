      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 lg:flex lg:justify-between">
        <div className="max-w-xl">
          ...
          <p className="mt-5 text-xl text-gray-400">
            See the status of all your <i>pfSense</i>® firewalls from one page. You can also get a detailed view of any device that is accessible from the dashboard. View, create, update or delete operations you’re used to from inside pfSense’s own dashboard are all replicated within Mudmap. Everything in one location.
          </p>
        </div>
