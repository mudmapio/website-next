  ...
  return (
    <div className="relative bg-white overflow-hidden">
          ...
          <main
            ...
            <div className="sm:text-center lg:text-left">
              <h1
                ...
                <span
                  className="block xl:inline">Remotely Manage and Configure</span>{' '}
                <span className="block text-indigo-600 xl:inline">pfSense®</span>
                in the Cloud
              </h1>
              <p
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/3">
        <img
          className="h-56 w-o object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
